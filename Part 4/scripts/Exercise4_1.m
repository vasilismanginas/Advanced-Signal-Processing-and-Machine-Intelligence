...
LMS_step = 1 * 10^(-5);
LMS_order = 4;
[output_estimates, errors, weights] = LMS(removed_mean_signal, removed_mean_signal, LMS_order, LMS_step);
...
plot(output_estimates, 'LineWidth', 2, 'DisplayName', 'LMS output');
title('One-step ahed prediction of time series using LMS', 'FontSize', title_font);
xlabel('Sample');
ylabel('Amplitude');
